...
////  HW4
////
////  Created by William  Escobar on 5/25/23.
////
//
#ifndef Sequence_h
#define Sequence_h
...
//___________________DECLARATION____________________________//
template <typename ItemType> //template the class so we can have a sequence of any value
class Sequence
{
    public:
        //Default constructor
...
//other algorithm functions, these functions are templetated so they can receive a sequence of any type
...
//___________________IMPLEMENTATION____________________________//
...
//***************************************************************
template <typename ItemType>
Sequence<ItemType>& Sequence<ItemType>::operator= (const Sequence<ItemType>& other)
{
